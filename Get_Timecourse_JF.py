...
pathname = '/mnt/home/jfriedrich/voltage/06152017Fish1-2/'
...
for i, t in enumerate(ROI_info):
    ...
    if t['active'] == 1:
        ...
        plt.subplot(1, 2, 2).plot(np.arange(tlimit, len(t['norm_tcourse2'])) / 300, t['norm_tcourse2'][tlimit:len(
            t['norm_tcourse2'])] - 1 + 0.2 * (active_n - 1), color=(0.3, 0.3, 0.3))
